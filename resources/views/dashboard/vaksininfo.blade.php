            ...
            <div class="container mx-auto">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div class="bg-white rounded-lg shadow p-4">
                        ...
                        <p class="text-gray-600 mb-4">BCG, BCG vaccine (Bacillus Calmette Guerin) can be given from
                            birth.
                            ...
                            It's a good idea to do a tuberculin test first. BCG may be given if the tuberculin results
                            are
                            negative.</p>
                    </div>
                    <!-- Vaccine 2 -->
                    <div class="bg-white rounded-lg shadow p-4">
                        ...
                        <p class="text-gray-600 mb-4">The MMR vaccine contains vaccines that protect against three
                            viral
                            infections: measles, mumps and rubella.
                            MMR vaccine is given as a series of two doses with the first dose at 12 to 15 months of age
                            and the
                            second at 4 to 6 years of age.</p>
                    </div>
                    <!-- Vaccine 3 -->
                    <div class="bg-white rounded-lg shadow p-4">
                        <img src="/images/vaksin 3.jpg" alt="Vaksin 3" class="rounded-lg mb-4">
                        <h2 class="text-lg font-semibold mb-2">Hepatitis B Vaccine</h2>
                        <p class="text-gray-600 mb-4">The hepatitis B vaccine is a mandatory type of vaccine for babies
                            to
                            prevent hepatitis B virus infection which causes liver disorders.
                            The hepatitis B vaccine contains inactivated hepatitis B virus antigen (HBsAg).
                            When it enters the body, the antigen will stimulate the immune system to produce antibodies
                            that can
                            fight the hepatitis B virus.</p>
                    </div>
                </div>
            </div>
