    ...
    <div class="p-4 sm:ml-64 flex-grow">
        <div class="p-4  rounded-lg mt-8">
            <div id="app" class="container mx-auto">
                <h1 class="text-2xl font-semibold mb-4">Immunization History</h1>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($schedules as $schedule)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $schedule->doctors }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $schedule->location }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $schedule->gender }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $schedule->age }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
